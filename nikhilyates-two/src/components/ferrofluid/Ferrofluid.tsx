...
export default function Ferrofluid({
  ...
  // Stable key so inline color arrays from parents don't thrash the WebGL context.
  ...
  useEffect(() => {
    ...
    // Listen on window so the effect still tracks the cursor while sitting under UI.
